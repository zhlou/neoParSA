...
#include <mpi.h>
#include "pannealer.h"
#include "move/scheduleThetaMoveP.h"
...
int main(int argc, char** argv)
{
    ...
    feedbackMix<Organism>::Param mixParam(root_node);
    pannealer<Organism, expHoldP, criCountP, scheduleThetaMoveP, feedbackMix>
            *annealer = new pannealer<Organism, expHoldP, criCountP,
            scheduleThetaMoveP, feedbackMix>(embryo, rnd, scheParam, frozenParam,
