...
int main(int argc, char** argv)
{
    ...
    twoTierMix<Organism>::Param mixParam(root_node);
    pannealer<Organism, expHoldP, criCountP, scheduleThetaMoveP, twoTierMix>
            *annealer = new pannealer<Organism, expHoldP, criCountP,
            scheduleThetaMoveP, twoTierMix>(embryo, rnd, scheParam, frozenParam,
