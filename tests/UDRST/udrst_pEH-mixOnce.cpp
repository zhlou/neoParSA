...
int main(int argc, char **argv)
{
    ...
    mixOnce<udrst>::Param mixParam(docroot);
    pannealer<udrst, expHoldP, tempCountP, parallelFBMove, mixOnce>
            *rst_sa = new pannealer<udrst, expHoldP, tempCountP,
                                    parallelFBMove, mixOnce>
