...
int main(int argc, char **argv)
{
    ...
    pannealer<fly, expHoldP, criCountP, parallelTempMove, intervalMix>
        *sa = new pannealer<fly, expHoldP, criCountP, parallelTempMove, intervalMix>(theFly, rnd, scheduleParam, frozenParam, mixParam, docroot, mpiState);
