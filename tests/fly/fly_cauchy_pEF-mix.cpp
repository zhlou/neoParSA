...
int main(int argc, char **argv)
{
    ...
    pannealer<fly, expHoldP, criCountP, parallelCauchyMove, intervalMix>
        *sa = new pannealer<fly, expHoldP, criCountP, parallelCauchyMove, intervalMix>(theFly, rnd, scheduleParam, frozenParam, mixParam, docroot, mpiState);
