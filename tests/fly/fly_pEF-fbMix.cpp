...
int main(int argc, char **argv)
{
    ...
    pannealer<fly, expHoldP, criCountP, parallelFBMove, feedbackMix>
        *sa = new pannealer<fly, expHoldP, criCountP, parallelFBMove, feedbackMix>(theFly, rnd, scheduleParam, frozenParam, mixParam, docroot, mpiState);
