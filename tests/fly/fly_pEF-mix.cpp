...
int main(int argc, char **argv)
{
    ...
    pannealer<fly, expHoldP, criCountP, parallelFBMove, intervalMix>
        *sa = new pannealer<fly, expHoldP, criCountP, parallelFBMove, intervalMix>(theFly, rnd, scheduleParam, frozenParam, mixParam, docroot, mpiState);
