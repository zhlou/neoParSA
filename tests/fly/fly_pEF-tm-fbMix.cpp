...
#include "pannealer.h"
#include "move/parallelTempMove.h"
...
int main(int argc, char **argv)
{
    ...
    pannealer<fly, expHoldP, criCountP, parallelTempMove, feedbackMix>
        *sa = new pannealer<fly, expHoldP, criCountP, parallelTempMove, feedbackMix>(theFly, rnd, scheduleParam, frozenParam, mixParam, docroot, mpiState);
